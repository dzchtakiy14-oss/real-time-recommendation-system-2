...
Load testing was conducted using Locust.

* **Throughput:** ~250 RPS
* **P95 latency:** 200 ms
* **P99 latency:** 400 ms

The system maintains low latency even under high load, with the majority of requests completed within sub-200 ms response time, indicating efficient real-time inference and retrieval.
